...
import { Droplets, AlertTriangle, CheckCircle, FileText, Download, Radio, TrendingUp } from "lucide-react";
import {
                ...
                <div className={styles.leftColumn}>
                    ...
                    <Card className={styles.mapCard}>
                        <div className="w-full h-full">
                            {/* Using a key forces re-render if needed, but simple mount is fine */}
                            <DashboardMap />
                        </div>
                    </Card>
                </div>
